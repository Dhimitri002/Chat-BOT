# ═══════════════════════════════════════════════════════════════
# Flora Platform — Commands Screen
# ═══════════════════════════════════════════════════════════════
...
class CommandsScreen(MDScreen):
    """List and manage bot commands (/ajuda, /info, etc.)."""
    ...
    def _build_ui(self):
        ...
        info_card.add_widget(MDLabel(
            text="📋 Comandos sao atalhos que os usuarios digitam com '/' para acoes rapidas.",
            font_style="Label",
            role="medium",
            theme_text_color="Custom",
            text_color=(0.7, 0.7, 0.75, 1),
        ...
        # Commands list
        self.commands_list = MDBoxLayout(
            orientation="vertical",
            spacing=dp(8),
            size_hint_y=None,
            adaptive_height=True,
        ...
        sample_commands = [
            {
                ...
                "response": "Aqui estao meus comandos:\n/ajuda - Ver comandos\n/info - Sobre o bot\n/contato - Falar com humano\n/planos - Ver planos",
                "enabled": True,
            },
            {
                "command": "/info",
                "description": "Informacoes sobre o bot",
                "response": "Sou um bot da Flora Platform 🌸\nVersao 1.0 - Feito com amor!",
                "enabled": True,
            },
            {
                "command": "/contato",
                "description": "Falar com um humano",
                "response": "Vou te conectar com nossa equipe! Aguarde um momento... 🧑‍💼",
                "enabled": True,
            },
            {
                "command": "/planos",
                "description": "Ver planos disponiveis",
                "response": "Nossos planos:\n- Basico: R$29/mes\n- Pro: R$59/mes\n- Enterprise: R$149/mes\n\nUse /upgrade para saber mais! 💰",
                "enabled": True,
            },
            {
                "command": "/status",
                "description": "Status da conta",
                "response": "Seu plano: Basico\nMensagens hoje: 15/100\nValidade: 30 dias restantes",
                "enabled": False,
            },
        ]

        for cmd in sample_commands:
            card = self._create_command_card(cmd)
            self.commands_list.add_widget(card)

        content.add_widget(self.commands_list)
        scroll.add_widget(content)
        layout.add_widget(scroll)
        self.add_widget(layout)

    def _create_command_card(self, cmd: dict) -> MDCard:
        ...
        card.add_widget(MDLabel(
            text=f"Resposta: {cmd['response'][:60]}...",
            font_style="Label",
            role="small",
            theme_text_color="Custom",
            text_color=(0.7, 0.7, 0.75, 1),
        ...
        footer.add_widget(MDBoxLayout(size_hint_x=0.5))
    ...
    def _on_add(self, instance):
        ...
        try:
            ...
            if app and hasattr(app, 'show_snackbar'):
                app.show_snackbar("Formulario de novo comando em breve!", (0.424, 0.388, 1.0, 1))
        except Exception:
            pass
